...
>>>>>>> 40088cb8f82bbd3bf328394131aa9636e06a3b9a
        ...
        <div>
          <div className="text-center mt-16">
            ...
            <p className="mb-4">
              <span className="text-lg font-medium">Physical Address:</span> 123
              Fake Street, Fictionville, FS 12345
            </p>
            <p>
              <span className="text-lg font-medium">Social Media Links:</span>
              Facebook: https://www.facebook.com/examplerealestate <br />
              Twitter: https://twitter.com/examplerealestate <br />
              Instagram: https://www.instagram.com/examplerealestate
            </p>
          </div>
        </div>
      </div>
